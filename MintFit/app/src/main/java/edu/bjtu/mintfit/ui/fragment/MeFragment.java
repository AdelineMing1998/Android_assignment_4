...
import edu.bjtu.mintfit.ui.activity.SelfActivity;
...
public class MeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((TextView)view.findViewById(R.id.tv_me_info)).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        if (getActivity() != null) {
            ...
            ((TextView)view.findViewById(R.id.user_name)).setText(userEntities[0].getUsername());
            cdb.close();
        }
        return view;
    }
